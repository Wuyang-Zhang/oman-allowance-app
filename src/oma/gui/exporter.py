...
def export_monthly_settlement_excel(
    *,
    ...
    config_headers = [
        ...
        header("export.header.study_month"),
        header("export.header.baggage_usd"),
        header("export.header.fx_rate"),
        header("export.header.issue_entry_month"),
    ...
    config_rows = [
        {
            ...
            header("export.header.study_month"): str(getattr(config_row, "study_allowance_month", 10)),
            ...
            header("export.header.issue_entry_month"): str(getattr(config_row, "issue_study_if_entry_month", 0)),
