...
def init_db(conn: sqlite3.Connection) -> None:
    ...
    _ensure_column(conn, "configs", "study_allowance_month", "INTEGER NOT NULL DEFAULT 10")
    _ensure_column(conn, "configs", "issue_study_if_entry_month", "INTEGER NOT NULL DEFAULT 0")
